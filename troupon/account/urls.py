...
from account.views import UserSigninView, ForgotPasswordView, ResetPasswordView,UserSignupView,ActivateAccountView, Userconfirm,UserChangePassword, UserSignoutView
